...
do_install:append:system1() {
    ...
    install -m 0755 ${UNPACKDIR}/system1-board.bin ${D}${base_datadir}/system1-board.bin
    install -m 0755 ${UNPACKDIR}/system1-mudflap.bin ${D}${base_datadir}/system1-mudflap.bin
}
