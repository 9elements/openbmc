...
SRC_URI:append:genesis3 = " file://networkd-override.conf"
...
do_install:append:genesis3() {
        ...
        install -m 644 -D ${WORKDIR}/networkd-override.conf ${D}${systemd_system_unitdir}/systemd-networkd-wait-online.service.d/networkd-override.conf
}
